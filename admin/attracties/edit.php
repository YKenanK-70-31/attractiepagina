...
<html lang="nl">
<head>
    <title>Attractie aanpassen</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        ...
        <form action="../backend/ridesController.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <img src="<?php echo $base_url . "/img/attracties/" . $ride['img_file']; ?>" alt="attractiefoto" style="max-width: 120px; display:block; margin-bottom: 0.5rem;">
